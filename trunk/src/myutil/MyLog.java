...
public class MyLog
{
	...
	public static void serverCatch(String programName, int line_number, Throwable exc)
	{
		myCatch("serverCatch", programName, line_number, exc);
	}

	public static void myCatch(String programName, int line_number, Throwable exc)
	{
		myCatch("catch", programName, line_number, exc);
	}

	public static void myCatch(String reportType, String programName, int line_number, Throwable exc)
	{

		String message = " entered catch in " + programName + " @ line # " + line_number;
	...
	public static void testLog(String message)
	{
		...
		String messageTime = " @: " + AU1.getLogCurrDateTime().substring(12) + " Thread:" + Thread.currentThread().getName() + " ";
	...
	{
		String textPrint = "";
		while ((text.length() > 78) && ((text.indexOf("\n") < 0) || (text.indexOf("\n") > 78)))
		{
	...
	public static void myConn(String string, String string0, String string1, int i)
	{
		return;
	}

	public static void myConn2(String string, String string0, String string1, int i)
	{
		return;
	}
}
