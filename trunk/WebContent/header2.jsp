...
<%-- 									<s:select name="cat_id" headerKey="-1" headerValue="CATEGORIES" list = "lstCats"/> --%>
										<a id="BrowseCategories" class="has-subnav" name="BrowseCategories"
											href="allcategories.action">CATEGORIES</a>
											<ul class="subnav">
												<li><a class="email-feedback" href="category1" onclick="">Category 1</a></li>
												<li class="no-chatback"><a href="Category 2">Category 2</a></li>
												<li class="chatback"><a	href="Category 3">Category 3</a></li>
											</ul>
