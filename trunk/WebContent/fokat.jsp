...
<body id="body" onload="document.getElementById('_nkw').focus()" dir="rtl">
				...
				<div class="pcontent">
					...
					<span class="coupon"></span><span></span>
							...
							<div id="headerWrapper" class="gh-hbw">
								<div class="gh-hb">
									<div class="gh-mn" id="menu1" dir="rtl"  onmouseover="show('menu1');" onmouseout="hide('menu1');">
