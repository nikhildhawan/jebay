	...
	<div class="divstyle">
		<div class="navTabContainer">
			<div class="navTabListContainer">
				<div>
					<ul class="navtabs">
						<li class="active"><a href="getpaisa" id="tab1"
		...
		<div class="blueboxcontb">
			<div class="blueboxconlrshort">
				<div class="content_area">
					<div class="subhead">My PaisaPay summary</div>
								...
								<div class="bluegrayboxrt">
									<div class="bluegrayboxtb">
										<div class="bluegrayboxlr">
											<span class="txt-black13bold">Buying To do's &amp;
												Alerts</span>
										</div>
									</div>
								</div>
							...
							<div class="yellowboxconrd">
								<div class="yellowboxcontb">
									<div class="yellowboxconlr">
										<div>You have no To do's or Alerts</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="bluegrayboxld">
							<div class="bluegrayboxlt">
								<div class="bluegrayboxrt">
									<div class="bluegrayboxtb">
										<div class="bluegrayboxlr">
											<span class="txt-black13bold">Selling To do's &amp;
												Alerts</span>
										</div>
									</div>
								</div>
														...
														<table width="100%" cellpadding="0" cellspacing="0"
															...
															<tr>
																...
																<a
																	...
																	href="#">How to sell with PaisaPay</a>.
																</s:if>
																<s:else>
																	...
																	<a href="getpaisaform">Registration details</a> and <a href="#">Account balance</a> tabs respectively.
