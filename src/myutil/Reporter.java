...
public class Reporter
{
	...
	public PrintWriter getNewWriter(String fileName)
	{
		...
		try
		{
			System.out.println("The path got from system properties is:" + fileName);
	...
	public void print(String message, boolean replaceCRLF)
	{
		...
		else if ((this.reportType.indexOf("log") >= 0) || (this.reportType.indexOf("catch") >= 0) || (this.reportType.contains("io")))
		{
			prefix = "@: " + AU1.getLogCurrDateTime().substring(12) + " Thread:" + Thread.currentThread().getName() + " ";
		}
		if (replaceCRLF)
		{
		...
		if ((this.reportType.indexOf("server") >= 0) || (this.reportType.startsWith("IVTS")))
		{
