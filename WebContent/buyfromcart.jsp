																									...
																									<div class="item-summ-body-c">
																										<div class="item-summ-body-image">
																											<div style="Height: 80px; Width: 80px;">
																												...
																												<img
																													src="retrieve.jsp?item_id=<s:property value="item_id"/>" width="75" heigth="75"
																													alt="" border="0">
																												...
																												<tbody>
																													<tr>
																														...
																														<td class="priceDivTd"><div
																																class="priceDiv" id="regsubtotal"><%= Integer.parseInt(session.getAttribute("cart_quantity").toString())*(Integer.parseInt(session.getAttribute("item_price").toString())) %></div>
																														</td>
																													</tr>
																												</tbody>
																											</table>
																							...
																							<s:iterator value="lstItemDetails">
																								<div>
																									<div class="sub-div" style="height: 100px;"
																										...
																										<div class="sub-div-right2"><%= Integer.parseInt(session.getAttribute("cart_quantity").toString())*(Integer.parseInt(session.getAttribute("item_price").toString())) %></div>
																										...
																										<div class="sub-div-mtotal"
																											style="width: 7.7%">Rs.</div>
																										<div class="sub-div-rtotal"><%= session.getAttribute("totalPrice") %></div>
